param(
    ...
    [string]$ProjectPath = "..\src\RacingLeaderboards.Infrastructure.Persistence\RacingLeaderboards.Infrastructure.Persistence.csproj",
    [string]$StartupProjectPath = "..\src\RacingLeaderboards.Api\RacingLeaderboards.Api.csproj"
)
